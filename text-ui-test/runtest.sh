...
# Print header
echo -e "${BOLD}===============================================${NC}"
echo -e "${BLUE}               Listo Test Runner              ${NC}"
echo -e "${BOLD}===============================================${NC}\n"
...
if ! javac -cp ../src/main/java -Xlint:none -d ../bin ../src/main/java/listo/*.java
then
    echo -e "\n${RED}╔════ ERROR ══════════════════════════════════╗${NC}"
...
java -classpath ../bin listo.Launcher < input.txt > ACTUAL.TXT
